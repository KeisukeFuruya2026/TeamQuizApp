namespace TeamQuizApp
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            ui = new UiUpdater(questionLabel, new[] { answerButton1, answerButton2, answerButton3, answerbButton4 }, logListBox);
            LoadNextQuestion();
        }
        ...
        private void answerButton_Click(object sender, EventArgs e)
        {
            ...
            int index = Array.IndexOf(new[] { answerButton1, answerButton2, answerButton3, answerbButton4 }, btn);
        ...
        {
            current = loader.GetRadomQuestion();
